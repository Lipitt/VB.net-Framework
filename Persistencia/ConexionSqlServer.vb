...
Imports FrameworkLipshitz.Persistencia
...
Public Class ConexionSqlServer
    ...
    Public Function EjecutarEscalar(consulta As String, parametros As Dictionary(Of String, Object)) As Object Implements IConexion.EjecutarEscalar
        ...
        Dim unComando = ObtenerComando(consulta, parametros)
    ...
    Public Function ObtenerComando(consulta As String, parametros As Dictionary(Of String, Object)) As SqlCommand
